    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">                  
          ...
          <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa-solid fa-gears"></i>Master <i class="fa-solid fa-chevron-down left-align"></i></a>
      ...
      <div class="admin-menu">
        ...
        <ul id="side-admin-menu" class="side-menu list-unstyled"> 
          <li> <a href="{{ route('admin.pesan') }}"> <i class="fa-regular fa-envelope"></i>Pesan Masuk</a></li>
        </ul>
      </div>
    </div>
</nav>