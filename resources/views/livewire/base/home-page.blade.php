    ...
    <div class="home">
        <div class="home_slider_container">
            ...
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slider Item -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url({{ asset('/img/slide/berdoa.jpg') }})"></div>
                    <div class="home_content">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="home_content_inner">
                                        <div class="home_title"><h1>GEREJA PANTEKOSTA DI INDONESIA</h1></div>
                                        <div class="home_text">
                ...
                <div class="row">
                        ...
                        <div class="box working_hours">
                            ...
                            <div class="working_hours_list">
                                <ul>
                                    ...
                                    <h3>	<div>Doa Dan Puasa Jumat : 09:00 s/d selesai 1 X seminggu</div></h3>
                                    </li>
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="col-lg-4 box_col">
                        <div class="box box_emergency">
                            ...
                            <div class="box_emergency_text">Pdt. Hanny. Mawei, M.Th</div>
                      ...
                      <i class="fa fa-whatsapp fa-stack-1x fa-inverse"></i>
                       </span>Chat: 0821-8993-2035</a> 
                       <br>
                            <a href="tel:085277948885">
                            <span class="fa-stack fa-lg">
                      <i class="fa fa-circle fa-stack-2x"></i>
                      <i class="fa fa-phone fa-stack-1x fa-inverse"></i>
                       </span>Call : 0821-8993-2035</a> 
    ...
    <section id="contact" class="wow fadeInUp">
        <div class="services">
            <div class="container">
                ...
                <div class="row services_row card-service-wrapper">
                    @foreach ($JadwalGenerate as $jadwal_generate)
                        <div class="col-lg-4 col-md-6 service_col">
                            <div class="service text-center trans_200">
                                <div class="service_icon"><img class="svg" src="{{ asset('/img/images/alarm-clock.svg') }}" alt=""></div>
                                <div class="service_title trans_200">Ibadah {{ $jadwal_generate->ibadah->name }}</div>
                                <div class="service_text">
                                    @php
                                        // $jadwal = new DateTime( $this->get_relevant_jadwal($jadwal_generate) );
                                        $jadwal = $this->get_relevant_jadwal($jadwal_generate);
                                    @endphp
                                    <div class="service_title trans_200">{{ $this->get_date($jadwal->waktu) }}</div>
                                    <div class="trans_200">{{ $this->get_time($jadwal->waktu) }}</div>
                                    @php
                                        $jemaat = $this->get_jemaat($jadwal->tempat_ibadah);
                                    @endphp
                                    <div class="trans_200">{{ $jemaat->nama }}, {{ $jemaat->keluarga }}</div>
                                </div>
                                <div class="button dept_button"><a href="{{ route('ibadah', ['ibadah_id' => $jadwal->id]) }}">READ MORE</a></div>
                            </div>
                        </div>                        
                    @endforeach                    
                </div>
			...
			<div class="row">
				<div class="col">
					<div class="cta_content text-center">
						...
						<div class="button cta_button"><a href="#">MINGGU : 08:00 - SELESAI</a></div>
					</div>
				</div>
			</div>
		</div>		
